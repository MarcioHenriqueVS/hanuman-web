...
import 'package:web_test/src/chat_view/src/widgets/reaction_widget.dart';
...
class _VoiceMessageViewState extends State<VoiceMessageView> {
  ...
  bool isExpanded = false; // Controla se a transcrição está visível.

  @override
  void initState() {
    super.initState();
    debugPrint('Chegou na voice message view...');
