...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<LoginBloc, LoginState>(
      ...
      if (state is LoginSuccess) {
        ...
        //     .pushAndRemoveUntil('/', (Route<dynamic> route) => false);
        context.go('/');
      ...
      return BlocConsumer<RegisterBloc, RegisterState>(
        listener: (context, registerState) async {
          if (registerState is RegisterLoading || state is LoginLoading) {
          ...
          if (registerState is RegisterSuccess) {
            ...
            tratamentoDeErros.showErrorSnackbar(context, registerState.error);
          }
        },
        builder: (context, registerState) {
          return AnimatedLogin(
            ...
            onSignup: (SignUpData data) async {
              ...
              registerState is RegisterFailure
                  ? tratamentoDeErros.showErrorSnackbar(
                      context, registerState.error)
                  : null;
              registerState is RegisterSuccess
                  ?
            ...
            logo: Image.asset('assets/images/logoTeste.png'),
            //backgroundImage: 'assets/images/hanumanIcon.png',
  ...
  LoginTexts get _loginTexts => LoginTexts(
        ...
        login: 'Entrar',
        signUp: 'Cadastrar',
        // signupEmailHint: 'Email de Cadastro',
        // loginEmailHint: 'Email de Login',
        // signupPasswordHint: 'Senha de Cadastro',
        // loginPasswordHint: 'Senha de Login',
      );
