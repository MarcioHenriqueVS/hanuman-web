...
class LoginTexts extends ChangeNotifier {
  ...
  static const String _defaultWelcome = 'HANUMAN';
  static const String _defaultWelcomeDescription = kIsWeb
      ? 'Treinamentos automatizados'
      : 'Treinamentos automatizados';
  static const String _defaultSignUp = 'Cadastrar';
  static const String _defaultSignUpFormTitle = 'Cadastrar-se';
  static const String _defaultSignUpUseEmail = 'ou use seu email para entrar:';
  static const String _defaultNotHaveAnAccount = 'Não tem uma conta?';
  static const String _defaultWelcomeBack = 'HANUMAN';
  static const String _defaultWelcomeBackDescription = kIsWeb
      ? 'Treinamentos automatizados'
      : 'Treinamentos automatizados';
  static const String _defaultLogin = 'Login';
  static const String _defaultLoginFormTitle = 'Selecione';
  static const String _defaultLoginUseEmail = 'ou use seu email para entrar:';
  static const String _defaultForgotPassword = 'Esqueceu a senha?';
  static const String _defaultAlreadyHaveAnAccount = 'Já tem uma conta?';

  static const String _defaultNameHint = 'Nome';
  static const String _defaultSignupEmailHint = 'Email';
  static const String _defaultSignupPasswordHint = 'Senha';
  static const String _defaultLoginEmailHint = 'Email';
  static const String _defaultLoginPasswordHint = 'Senha';
  static const String _defaultConfirmPasswordHint = 'Confirmar Senha';

  static const String _defaultPasswordMatchingError =
      'As senhas não coincidem!';
  static const String _defaultDialogButtonText = 'OK';
  static const String _defaultChooseLanguageTitle = 'Escolha o idioma:';
  static const String _defaultAgreementText = 'Eu concordo com os ';
  static const String _defaultPrivacyPolicyText = 'Política de Privacidade';
  static const String _defaultTermsConditionsText = 'Termos e Condições';
  static const String _defaultPrivacyPolicyLink = 'about:blank';
  static const String _defaultTermsConditionsLink = 'about:blank';
