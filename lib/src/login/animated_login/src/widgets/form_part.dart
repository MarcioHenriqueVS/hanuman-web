  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      padding: loginTheme.socialLoginPadding ??
          EdgeInsets.fromLTRB(dynamicSize.height * 1.5, dynamicSize.height * 1.5, dynamicSize.height * 1.5, dynamicSize.height * 3),
      child: Wrap(
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      padding: loginTheme.formPadding ??
          EdgeInsets.symmetric(vertical: dynamicSize.height * 1),
      child: Form(
        key: auth.formKey,
        child: Wrap(
