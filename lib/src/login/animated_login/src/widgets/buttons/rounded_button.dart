...
class _RoundedButtonState extends State<RoundedButton> {
  ...
  ButtonStyle _defaultButtonStyle(BuildContext context, bool isLandscape) =>
      ButtonStyles(context).roundedStyle(
        ...
        borderColor: widget.borderColor ?? (isLandscape ? null : Colors.green),
        ...
        textStyle: TextStyles(context).bodyStyle(
          ...
          fontWeight: FontWeight.w400, // Reduzido de w500 para w400
        ),
        foregroundColor:
  ...
  double get _buttonWidth => _loading && loginTheme.showLoadingButton
      ? _loadingSize(context) * 2.5 // Reduzido de 3.3 para 2.5
      : widget.width ??
          DynamicSize(context).width *
              (loginTheme.isLandscape
                  ? 10
                  : 25); // Reduzidos os multiplicadores

  double get _buttonHeight =>
      widget.height ??
      DynamicSize(context).height *
          (loginTheme.isLandscape ? 6 : 5); // Reduzidos os multiplicadores
}
