  ...
  Widget _buildAssinaturaAtual() {
    return BlocBuilder<SubscriptionBloc, SubscriptionState>(
      builder: (context, state) {
        ...
        if (state is! SubscriptionLoaded || state.subscription.isEmpty) {
          return const SizedBox.shrink();
        }

        final assinatura = state.subscription;
                ...
                return Card(
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        onTap:
                            isCurrentPlan ? null : () => _selecionarPlano(plan),
                        borderRadius: BorderRadius.circular(15),
                        child: Padding(
      ...
      providers: [
        BlocProvider(
          create: (context) => SubscriptionBloc(FirebaseFirestore.instance)
            ..add(LoadSubscription(uid!)),
        ),
        BlocProvider(
          create: (context) => PlansBloc(_services)..add(LoadPlans()),
        ),
      ],
      child: Stack(
        children: [
          BlocBuilder<SubscriptionBloc, SubscriptionState>(
            builder: (context, state) {
              return SubscriptionProvider(
                ...
                currentStatus: state is SubscriptionLoaded
